...
\begin{center}
% \includegraphics[width=0.95\textwidth]{figuras/diagrama_arquitetura.png}
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}[Diagrama de arquitetura — a inserir]\vspace{2cm}}}
\captionof{figure}{Diagrama de componentes do ecossistema digital}
